...
export const DUOTONE_FILTERS = [
  ...
  { id: 'classic_reverse', label: 'Classic & Reverse',  classic: true,  reverse: true  },
]
...
/**
 * Applies the contrast S-curve matching the Python version:
 *   norm < 0.5 → pow(norm * 2, 1.8) / 2
 *   norm >= 0.5 → 1 - pow((1 - norm) * 2, 1.8) / 2
 */
 ...
 */
export async function renderDuotone(canvas, imageSrc, { classic = false, reverse = false } = {}) {
