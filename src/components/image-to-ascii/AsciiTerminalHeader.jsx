import { Circle, ImageIcon, Upload, X } from "lucide-react";

export default function AsciiTerminalHeader({
  asciiMeta,
  hasImage,
  imageFilename,
  onOpenImagePicker,
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        ...
        >
          {hasImage ? imageFilename : "ascii-terminal-preview"}
        </span>
      </div>
      ...
      <div className="flex items-center gap-2">
        {asciiMeta && (
          <span
            ...
            style={{ color: "var(--text-tertiary)" }}
          >
            {asciiMeta.columns} x {asciiMeta.lines} chars
          </span>
        )}
