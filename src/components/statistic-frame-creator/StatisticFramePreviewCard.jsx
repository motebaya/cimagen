...
export default function StatisticFramePreviewCard({
  fileInputRef,
  hasImage,
  imageFilename,
  imageSrc,
  ...
  return (
    ...
    >
      ...
      <CreatorPreviewHeader
        fileLabel={hasImage ? imageFilename : "statistic-frame-preview"}
        hasReplace={hasImage}
        ...
        >
          <div className="relative inline-block max-w-full">
            <canvas
              ...
              className="block max-w-full h-auto max-h-[640px]"
            />
            {isRendering && (
              <div
