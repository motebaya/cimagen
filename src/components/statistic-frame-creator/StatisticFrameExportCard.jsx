...
export default function StatisticFrameExportCard({
  disabled,
  exportMetadata,
  exportingFormats,
  onExport,
  ...
  return (
    <CreatorExportCardShell
      description="Export is enabled once an image is uploaded. The preview preserves the source aspect ratio while staying page-safe."
