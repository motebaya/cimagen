...
export default function DuotoneExportCard({
  disabled,
  exportMetadata,
  exportingFormats,
  onExport,
  ...
  return (
    <CreatorExportCardShell
      description="Export is enabled once an image is uploaded. Preview updates live as you switch between duotone modes."
