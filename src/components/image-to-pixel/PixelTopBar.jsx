...
export default function PixelTopBar() {
  return (
    <>
      ...
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: "var(--text-tertiary)" }}>
          Build retro pixel art with palette presets, dithering, outlines,
          preprocessing, live comparison, and flexible export output.
        </p>
      </div>
    </>
  );
