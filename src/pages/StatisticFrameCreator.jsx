...
export default function StatisticFrameCreator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Save to history (without image data to save space, just text state)
      ...
      setError(
        err.message || "Failed to generate the frame. Please try again.",
      );
    } finally {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: "var(--text-tertiary)" }}>
          Create statistic overlays on background images with customizable text.
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. SUCCESSFULLY UPLOADED!"
              className="w-full px-4 py-3 rounded-xl border text-sm transition-colors focus:outline-none"
              style={{
                backgroundColor: "var(--input-bg)",
                borderColor: "var(--border-color)",
          ...
          {hasGenerated && (
            ...
            >
              ...
              <ExportControls
                canvasRef={canvasRef}
                filename={`statistic-frame-${Date.now()}`}
